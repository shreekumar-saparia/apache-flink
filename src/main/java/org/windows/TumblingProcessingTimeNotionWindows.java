...
public class TumblingProcessingTimeNotionWindows {
    public static void tumblingWindowsWithProcessingTimeNotion(StreamExecutionEnvironment stEnv, ParameterTool params)
            throws Exception {

        stEnv.setStreamTimeCharacteristic(TimeCharacteristic.ProcessingTime);
        ...
        DataStream<Tuple5<String, String, String, Integer, Integer>> reduced = mapped
                .keyBy(new KeySelector<Tuple5<String, String, String, Integer, Integer>, String>() {
                    @Override
                    public String getKey(Tuple5<String, String, String, Integer, Integer> value) {
                        return value.f0;
                    }
                })
        ...
        reduced.writeAsText("<output-path>/output/tumbling_window_processing_time_op");
        // execute program
        stEnv.execute("Tumbling Windows With Processing Time Notion");
    }
