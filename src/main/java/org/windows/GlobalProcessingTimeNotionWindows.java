...
public class GlobalProcessingTimeNotionWindows {
    public static void globalWindowsWithProcessingTimeNotion(StreamExecutionEnvironment stEnv, ParameterTool params)
            throws Exception {
        ...
        reduced.writeAsText("<output-path>/output/global_window_processing_time_op");
        // execute program
        stEnv.execute("Global Windows With Processing Time Notion");
    }
