...
public class SessionProcessingTimeNotionWindows {
    public static void sessionWindowsWithProcessingTimeNotion(StreamExecutionEnvironment stEnv, ParameterTool params)
            throws Exception {
        ...
        //reduced.print();
        reduced.writeAsText("<output-path>/output/sliding_window_processing_time_op");
        // execute program
        stEnv.execute("Session Windows With Processing Time Notion");
    }
