...
public class SlidingProcessingTimeNotionWindows {
    public static void slidingWindowsWithProcessingTimeNotion(StreamExecutionEnvironment stEnv, ParameterTool params)
            throws Exception {
        ...
        // execute program
        stEnv.execute("Sliding Windows With Processing Time Notion");
    }
