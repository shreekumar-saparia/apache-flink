...
public class ReduceOperator {
    public static void reduceOperator(StreamExecutionEnvironment stEnv, ParameterTool params) throws Exception {
        ...
        DataStream<Tuple5<String, String, String, Integer, Integer>> reduced =
                mapped.keyBy(new KeySelector<Tuple5<String, String, String, Integer, Integer>, String>() {
                    @Override
        ...
        profitPerMonth.writeAsText("<output-path>/reduce_operator");

        // execute program
        stEnv.execute("Reduce Operator");
    }
